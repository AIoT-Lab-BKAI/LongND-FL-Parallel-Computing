...
python3 -u train_upperbound.py --train_mode="benchmark" --dataset_name="fashionmnist" --num_rounds=1000 --learning_rate=0.01 --batch_size=10 --path_data_idx="" --run_name="Upperbound-Featured-01-10%" --group_name="FMNIST-10"
