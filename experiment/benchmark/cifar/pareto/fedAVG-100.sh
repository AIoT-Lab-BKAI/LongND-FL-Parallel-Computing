...
python3 -u train.py --train_mode="benchmark" --dataset_name="cifar100" --num_clients=100 --clients_per_round=10 --num_rounds=1000 --learning_rate=0.01 --batch_size=10 --num_epochs=5 --path_data_idx="" --run_name="FedAVG-Pareto-100-Clients" --group_name="CIFAR-Pareto"
